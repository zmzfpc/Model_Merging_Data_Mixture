...
base_yaml="my_yaml/dare_qwc7_gs.yml"
...
for i in "${!hyperparams_combinations[@]}"; do
    ...
    output_dir="merged_model/dare_qwc7_d0_3_0_7_${experiment_id}"
...
echo "Results saved in merged_model/dare_qwc7_d0_3_0_7_* directories"
