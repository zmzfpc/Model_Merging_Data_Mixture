...
base_yaml="my_yaml/ties_dsc13_gs.yml"
...
for i in "${!hyperparams_combinations[@]}"; do
    ...
    output_dir="merged_model/ties_dsc13_gs_${experiment_id}"
...
echo "Results saved in merged_model/ties_dsc13_gs_exp* directories"
