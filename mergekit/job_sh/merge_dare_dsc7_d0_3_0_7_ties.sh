...
base_yaml="my_yaml/dare_dsc7_gs_ties.yml"
...
for i in "${!hyperparams_combinations[@]}"; do
    ...
    output_dir="merged_model/dare_dsc7_ties_${experiment_id}"
...
echo "Density: 0.3 and 0.4, Weight range: 0.1-0.9 (18 experiments)"
echo "Results saved in merged_model/dare_dsc7_d0_3_0_4_* directories"
