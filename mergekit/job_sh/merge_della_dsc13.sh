...
base_yaml="my_yaml/della_dsc13_gs.yml"
...
for i in "${!hyperparams_combinations[@]}"; do
    ...
    output_dir="merged_model/della_dsc13_gs_${experiment_id}"
...
echo "Results saved in merged_model/della_dsc13_gs_exp* directories"
