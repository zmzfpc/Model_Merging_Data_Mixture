...
base_yaml="my_yaml/dare_qwc15_gs_ties.yml"
...
for i in "${!hyperparams_combinations[@]}"; do
    ...
    output_dir="merged_model/dare_qwc15_ties_${experiment_id}"
...
echo "Results saved in merged_model/dare_qwc15_ties_* directories"
