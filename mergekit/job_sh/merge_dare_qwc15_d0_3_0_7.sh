...
base_yaml="my_yaml/dare_qwc15_gs.yml"
...
for i in "${!hyperparams_combinations[@]}"; do
    ...
    output_dir="merged_model/dare_qwc15_d0_3_0_7_${experiment_id}"
...
echo "Density: 0.3/0.7, Weight range: 0.1-0.9"
echo "Results saved in merged_model/dare_qwc15_d0_3_0_7_* directories"
