...
echo "granite_c8_full_sftct.yaml"
FORCE_TORCHRUN=1 llamafactory-cli train my_yaml/8b/ct/granite_c8_full_sftct.yaml \
    learning_rate=1e-6 \
    output_dir=saves/granitec8/best/sft_ct_1e6_1