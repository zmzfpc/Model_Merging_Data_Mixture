...
models=(
  # "/dccstor/unified-trans/model_merging/granite33_2/LLaMA-Factory/saves/qwen25c7/best/sft_ct_1e6"
  "/dccstor/unified-trans/model_merging/granite33_2/LLaMA-Factory/saves/qwen25c7/best/sft_4o_sol_5e6"
)
outputs=(
  # "qwenc257_pred_ct.jsonl"
  "qwenc257_pred_4o.jsonl"
)
