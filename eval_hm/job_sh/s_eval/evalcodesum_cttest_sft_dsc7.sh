...
models=(
  "/dccstor/unified-trans/model_merging/granite33_2/LLaMA-Factory/saves/dsc7/best/sft_ct_1e6"
  # "/dccstor/unified-trans/model_merging/granite33_2/LLaMA-Factory/saves/dsc7/best/sft_4o_sol"
)
outputs=(
  "dsc7_pred_ct.jsonl"
  # "dsc7_pred_4o.jsonl" 
